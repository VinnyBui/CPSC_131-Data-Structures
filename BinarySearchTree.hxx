...
template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::height(Node* ptr) 
{
    if (ptr == nullptr) 
        return -1;


    return 1 + std::max(height(ptr->left_) , height(ptr->right_));
}


template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::countNodes() {

    return countNodes(root_);
}

template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::countNodes(Node* ptr) 
{
    if (ptr == nullptr)
        return 0;

    return 1 + countNodes(ptr->left_) + countNodes(ptr->right_);
}


template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::countLeaves() {
    
    return countLeaves(root_);
}

template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::countLeaves(Node* ptr) {
    ...
    return  countLeaves(ptr->left_) + countLeaves(ptr->right_);
}


template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::findMin() {

    return findMin(root_);
}

template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::findMin(Node* ptr) {
...
template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::getNodeSum() {

    return getNodeSum(root_);
}

template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::getNodeSum(Node* ptr) {

    if (ptr == nullptr)
        return 0;

    return ptr->value_ + getNodeSum(ptr->left_) + getNodeSum(ptr->right_);
}

template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::getLeafSum() {

    return getLeafSum(root_);
}

template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::getLeafSum(Node* ptr) {
    ...
    return getLeafSum(ptr->left_) + getLeafSum(ptr->right_);
}

template <typename Key, typename Value>
void BinarySearchTree<Key, Value>::printDescendingOrder() const
{
    return printDescendingOrder(root_);
}

template <typename Key, typename Value>
void BinarySearchTree<Key, Value>::printDescendingOrder(Node* ptr) const
{
    if (ptr == nullptr) return;

    printDescendingOrder(ptr->right_);
    std::cout << *ptr;
    printDescendingOrder(ptr->left_);
